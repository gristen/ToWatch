    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                    <a href="index.blade.php" class="nav-link px-2 text-secondary d-flex align-items-center column-gap-2">
                ...
                <li>
                    <a href="categories.blade.php" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
            ...
            <div class="d-flex align-items-center text-end">
                <a href="auth/login.blade.php" type="button" class="btn btn-outline-light me-2 d-flex align-items-center column-gap-2">
                ...
                <a href="auth/register.blade.php" type="button" class="btn btn-warning d-flex align-items-center column-gap-2">
